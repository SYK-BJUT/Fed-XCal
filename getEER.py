...
# inner should be bigger than outer (metrics.roc_curve requires similarity-based matching score)
mIn = inscore.mean()
mOut = outscore.mean()
if mIn < mOut:
    inscore = -inscore
...
# EER calculation via intersection of FPR and FNR
eer = brentq(lambda x: 1. - x - interp1d(fpr, tpr)(x), 0., 1.)
thresh = interp1d(fpr, thresholds)(eer)

# Reverse back thresholds if needed
if mIn < mOut:
    thresh = -thresh
...
# Compute the mean EER (FPR and FNR)
